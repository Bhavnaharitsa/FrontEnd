...
public class SocialFragment extends Fragment implements ItemTouchCallback {

    private static String TAG = "SocialFragment";
    private static final String TAG_PRE = "[" + SocialFragment.class.getSimpleName() + "] ";
...
//                    listNos = i +" " + currentNos[i].getPackageName() + "\n" + listNos;
                ...
                if(Constants.SOCIAL_LIST.contains(currentNos[i].getPackageName())) {
